import { ProductGetMyListApi, UsersApi, UsersServiceListApi } from '@/app/redux/ApiCall/ApiAddress';
...
export default async function page({params}:{params:{userId:string,id:string}}) {
    ...
    const DataDetail2 = await res2.json()
     ...
     return (
        ...
        {/* <LayoutMobileInnerPage urlBack={'/business/services/'+params.userId} type='more'> */}
