...
export default function EventWinPage() {
  return (
    ...
    <div className="flex flex-row gap-x-4 mt-10 mb-5">
        <div className="basis-1/4 flex flex-col ">
            <div className="flex flex-row gap-x-2">
                {/* <SearchGray  /> */}
                <div>
                    <button className={`bg-[var(--orang)] h-[48px] rounded-[12px] px-4`}><img src={Vector.src} alt='filter' /></button>
                    ...
                    <div className="flex flex-row gap-x-4 p-4">
                        ...
                        <div className="container mx-auto w-[90%] py-4 flex flex-col">
                            ...
                            <div className={`flex flex-col gap-y-2 mt-5`}>
                                ...
                                <div><small className={`text-[var(--lightBlue)] font-bold`}>جهانی</small></div>
