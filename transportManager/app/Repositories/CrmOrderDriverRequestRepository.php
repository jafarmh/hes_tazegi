...
use App\Models\CrmOrderDriverRequest;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmOrderDriverRequestRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmOrderDriverRequest::query();
        return $query;
    }
    ...
    {
        return  CrmOrderDriverRequest::create($data);
    }
    ...
    public static function UpdateItemByFields($params,$data)
    {
        $query = (new self)->query();
        foreach($params as $key=>$value){
            $query=$query->where($key, $value);
