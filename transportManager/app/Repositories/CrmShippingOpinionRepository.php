...
use App\Models\CrmShippingOpinionDriver;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmShippingOpinionRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmShippingOpinionDriver::query();
        return $query;
    }
    ...
    {
        return CrmShippingOpinionDriver::create($data);
    }
