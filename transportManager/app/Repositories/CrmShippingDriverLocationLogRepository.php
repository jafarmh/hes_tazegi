...
use App\Models\CrmShippingDriverLocationLog;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmShippingDriverLocationLogRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmShippingDriverLocationLog::query();
        return $query;
    }
    ...
    {
        return CrmShippingDriverLocationLog::create($data);
    }
