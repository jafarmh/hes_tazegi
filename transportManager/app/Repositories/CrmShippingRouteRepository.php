...
use App\Models\CrmShippingRoute;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmShippingRouteRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmShippingRoute::query();
        return $query;
    }
    ...
    {
        return CrmShippingRoute::create($data);
    }
