...
use App\Models\CrmShippingLocation;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmShippingLocationRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmShippingLocation::query();
        return $query;
    }
    ...
    {
        return CrmShippingLocation::create($data);
    }
