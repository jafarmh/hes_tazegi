...
use App\Models\CrmShippingStatus;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pipeline\Pipeline;

class CrmShippingStatusRepository implements RepositoryInterface
{
    private function query(): \Illuminate\Database\Eloquent\Builder
    {
        $query=CrmShippingStatus::query();
        return $query;
    }
    ...
    {
        return CrmShippingStatus::create($data);
    }
