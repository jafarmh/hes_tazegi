...
namespace App\Http\Requests\Driver\Signup;
...
class SignupRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            "personnelImg"=>"required|mimes:jpeg,jpg,png|max:15000",
            "birthCertificateImg"=>"required|mimes:jpeg,jpg,png|max:15000",
            "nationalImg"=>"required|mimes:jpeg,jpg,png|max:15000",
            "certificateImg"=>"required|mimes:jpeg,jpg,png|max:15000",
            "smartCardImg"=>"required|mimes:jpeg,jpg,png|max:15000",
            "healthImg"=>"required|mimes:jpeg,jpg,png|max:15000",
